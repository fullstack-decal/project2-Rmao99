...
Hint: We need:
      ...
      function buttonClicked(valueClicked) {
          if (isNaN(parseInt(valueClicked.target.innerText))) { //NaN means "Not a Number"
              //Hint: call a function we just created!
              console.log("nan");
              makesSymbol(valueClicked.target.innerText);
          } else {
              //Hint: call a function we just created!
              console.log("num");
   
              makesNumber(valueClicked.target.innerText);
          }
          let res = document.querySelector(".result-screen");
